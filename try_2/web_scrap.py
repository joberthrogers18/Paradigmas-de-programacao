...
#Connect to database
'''
client = MongoClient('mongod://localhost:27017/')
db = client['mwtest']
colcourse = db['course']
'''
...
if __name__ == '__main__':
    try:
        ...
        '''
            ...
            dbConnection.save_habilitations(list_habilitations)
        ...
        for course in campus.courses:
            ...
            for habilitation in course.habilitations:
                #list_disciplines.append(habilitation.disciplines)
                print(habilitation.disciplines)
        ...
        for departament in campus.departments:
            ...
            list_disciplines.append(departament.disciplines)
        
        dbConnection.save_all_disciplines(list_disciplines)
        '''    
